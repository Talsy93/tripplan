...
// Mirrors the top of ExploreScreen: the title row, the search pill, the
// category grid (three across on a phone, six once the column is wide) and the
// AI box — so nothing moves when the real screen arrives.
