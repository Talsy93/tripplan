...
const variants: Record<Variant, string> = {
  // v6 (Stitch): a card is lifted by a blue-tinted shadow, not drawn by a line.
  ...
  interactive:
    "bg-surface shadow-card transition-[box-shadow,transform] duration-settle ease-snap hover:shadow-lift hover:-translate-y-0.5",
};
