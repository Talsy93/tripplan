...
export function chipClasses(active: boolean, className?: string) {
  return cn(
    "inline-flex shrink-0 cursor-pointer items-center gap-1.5 rounded-full border px-3.5 py-1.5 text-sm font-medium transition-[background-color,border-color,color,box-shadow,transform] duration-press ease-snap active:scale-[0.97]",
    ...
    active
      ...
      : "border-transparent bg-surface-sunken text-foreground hover:bg-surface-2",
    className,
  );
}
